        ...
        >
          {gen.generatedImage && (
            <img
              ...
              alt={gen.productName}
              className={`absolute inset-0 w-full h-full object-cover transition duration-500 ${gen.generatedVideo ? "group-hover:opacity-0" : "group-hover:scale105"} `}
            />
          )}
          ...
          <div className="absolute right-3 bottom-3">
            <img
              ...
              alt="product"
              className="w-16 h-16 object-cover animate-float rounded-full"
            />
            <img
              src={gen.uploadedImages[1]}
              alt="model"
              className="w-16 h-16 object-cover animate-float rounded-full -ml-8"
