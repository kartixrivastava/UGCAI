...
export const plansData = [
  {
    ...
    name: "Starter",
    price: "$10",
    desc: "Try the patform at no cost.",
    credits: 25,
    features: [
      "25 credits",
      "Standard quality",
  ...
  },
  {
    ...
    name: "Ultra",
    price: "$99",
    desc: "Sale across teams and agencies",
    credits: 300,
    features: [
      "300 Credits",
      "FHD quality",
...
export const faqData = [
  {
    ...
    answer:
      "We leverage state-of-the-art diffusion models trained on millions of product images to blend your product into relaistic scenes while preserving details, lightning and reflections.",
  },
  {
