    ...
    <div className="min-h-screen text-white p-6 md:p-12 mt-28">
      <form onSubmit={handleGenerate} className="max-w-4xl mx-auto mb-40">
        <Title
          ...
          description="Upload your model and product images to generate stunning UGC, short-from videos and social media posts"
        />
          ...
          <div className="w-full">
            ...
            <div className="mb-4 text-gray-300">
              ...
              <textarea
                ...
                className="w-full bg-white/3 rounded-lg boder-2 p-4 text-sm border-violet-200/10 focus:border-violet-500/50 outline-none resize-none transition-all"
              />
            </div>
            <div className="mb-4 text-gray-300">
            ...
            <div className="mb-4 text-gray-300">
              ...
              <textarea
                ...
                placeholder="Describe how you want the video to be!"
                className="w-full bg-white/3 rounded-lg boder-2 p-4 text-sm border-violet-200/10 focus:border-violet-500/50 outline-none resize-none transition-all"
              />
            </div>
          </div>
