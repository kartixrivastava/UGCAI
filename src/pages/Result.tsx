        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            <div className="glass-panel inline-block p-2 rounded-2xl">
              <div
                className={`${projectData.aspectRatio === "9:16" ? "aspect-9/16" : "aspect-video"} sm:max-h-200 rounded-xl bg-gray-900 overflow-hidden`}
              >
          ...
          <div className="space-y-6 ">
            ...
            <div className="glass-panel p-6 rounded-2xl relative overflow-hidden">
              ...
              <p className="text-gray-400 text-sm mb-6">
                Turn this static image into dynammic video for social media.
              </p>
              {!projectData.generatedVideo ? (
                <PrimaryButton
